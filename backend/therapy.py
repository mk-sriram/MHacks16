...
def GetPicToDisplay(msg, use_emotion = false):
        ...
        mess = [
            {"role": "system", "content": "You will be given a prompt and an emotion, based on how you belive, you will say either anger, glee, negative, nuetral, positive, or suprised: "}
        ...
        if(imageChoice.choices[0].message.content == "anger")
            return "anger.png"
        else if(imageChoice.choices[0].message.content == "glee"):
            return "glee.png"
        else if(imageChoice.choices[0].message.content == "negative"):
            return "negative.png"
        else if(imageChoice.choices[0].message.content == "nuetral"):
            return "nuetral.png"
        else if(imageChoice.choices[0].message.content == "positive")
            return "postive.png"
        else if(imageChoice.choices[0].message.content == "suprised")
            return "suprised.png"
        else
            return "nuetral.png"
    )
